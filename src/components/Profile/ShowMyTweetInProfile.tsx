...
const ShowMyTweetInProfile = ({ usersProfile, currentUser, messages, setUsersProfile, userObj, myTweetList, setTweetDetail, setToastAlert, setToastText, currentPage, setCurrentPage, randomUsersProfile } : ShowMyTweetInProfileProp) => {
